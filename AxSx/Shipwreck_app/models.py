...
class ShipWreck(models.Model):
    ...
    latitude = models.DecimalField(db_column="Lat", max_digits=20, decimal_places=15, blank=True, null=True)  # Field name made lowercase.
    longitude = models.DecimalField(db_column="Lng", max_digits=20, decimal_places=15, blank=True, null=True)  # Field name made lowercase.
